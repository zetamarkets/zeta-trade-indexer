...
import { EventQueueHeader, EventQueueLayout } from "./types";
...
const EVENT = struct<EventQueueLayout>([
  EVENT_FLAGS,
  u8("openOrdersSlot"),
  u8("feeTier"),
  blob(5),
